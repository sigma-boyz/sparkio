  ...
  return (
    <div className="friends-container">
      <div className="tabs">
        ...
        <button className={activeTab === 'add' ? 'active' : ''} onClick={() => setActiveTab('add')}>Add Friends</button>
...
const UserItem = ({ username, profilePic, buttonText, isRequest, addFriend, uid, acceptRequest }) => {
  return (
    <div className="user-item">
      ...
      <span>{username}</span>
      {buttonText && <button className="add-friend" onClick={addFriend}>{buttonText}</button>}
      {isRequest && (
